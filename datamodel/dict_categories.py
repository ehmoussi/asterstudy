...
# Unittests environment is detected using ASTERSTUDYTST
if os.environ.get('ASTERSTUDYTST'):
    from .dict_categories_test import CATEGORIES_DEFINITION
    DEPRECATED = ['_JUST_FOR_COVERAGE_']
